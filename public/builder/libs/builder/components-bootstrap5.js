...
["html/container","html/spacer", "html/gridrow", "html/btn", "html/btn-link", /*"html/buttongroup", "html/buttontoolbar"*/, "html/alert", "html/card"/*, "html/listgroup"*/, "html/badge"/*, "html/progress", "html/navbar", "html/breadcrumbs", "html/pagination"*/];
...
Vvveb.Components.extend("_base", "html/container", {
    ...
    html: '<div class="container" style="min-height:150px;"><div class="m-5"></div></div>',
    name: "Container",
    properties: [
     {
        name: "Type",
...
Vvveb.Components.extend("_base", "html/spacer", {
    ...
    name: "Spacer",
    html: '<div class="spacer" style="height: 20px;"></div>',
    properties: [{
        name: "Height",
        key: "height",
        htmlAttr: "style",
        inputtype: TextInput,
        data: {
            placeholder: "Enter height in pixels (e.g., 20px)"
        }
    }]
});
...
Vvveb.Components.extend("_base", "html/gridrow", {
    ...
    classes: ["row"],
    html: '<div class="row"><div class="col-sm-4"></div><div class="col-sm-4 col-5"></div><div class="col-sm-4"></div></div>',
    children :[{
