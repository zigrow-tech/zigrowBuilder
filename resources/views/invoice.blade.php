...
*{
    ...
    <style type="text/css">
  @page { size: 240mm 360mm;   /* or 230mm 320mm */
    margin: 15mm;   }
    ...
    <div style="display:block; padding:0px 16px;">
        <div class="wrap">
            ...
            <div class="container-pad">
                ...
                <table width="100%" class="border-b" cellspacing="0" cellpadding="0" style="margin-bottom:14px; padding-bottom: 16px;">
                    <tr>
                        <!-- Left: Logo -->
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                     <td style="padding:0;">
                                        ...
                                        <span class="muted">{{ $pdfData['payment_date'] ? $pdfData['payment_date'] ?? '' :''}}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <div style="position:absolute; top: -5px; right:-24px; transform:rotate(40deg);
                ...
                <!-- ORDER SUMMARY -->
                <div class="muted-2 heading" style="margin:16px 0 10px 0; font-weight:600; font-family: Helvetica, Arial, sans-serif !important;">Order Summary</div>
                    ...
                    <table class="table" cellpadding="0" cellspacing="0" style="color:#4b5563;">
                        <thead>
                            <tr style="background:#f9fafb; color:#374151; text-transform:uppercase;">
                                ...
                                <th align="left" style="padding:10px 16px; border-bottom:1px solid #e5e7eb;">Price</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr style="background:#ffffff; border-bottom:1px solid #e5e7eb;">
                                <td style="padding:10px 16px; color:#111827; font-weight:600; font-family: Helvetica, Arial, sans-serif;">{{$pdfData['plan_name']??''}}</td>
                            ...
                            <tr style="background:#f5f7ff;">
                                ...
                                <td style="padding:12px 16px; font-weight:700; color:#111827;" class="rs">₹{{$pdfData['net_amount_paid']}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <!-- ORDER DETAILS -->
                <div class="muted-2 heading" style="margin:18px 0 12px 0; font-weight:600; font-family: Helvetica, Arial, sans-serif;">Order Details</div>
                <div style="overflow-x:auto;">
                    <table class="table" cellpadding="0" cellspacing="0" style="color:#4b5563;">
                        <tbody>
                            <tr style="background:#ffffff;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827; width:38%;">
                                    Name</th>
                                <td class="td" style="color:#1f2937;">{{$pdfData['full_name']}}</td>
                            </tr>
                            <tr style="background:#f9fafb;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Phone Number
                                </th>
                                <td class="td" style="color:#1f2937;">{{$pdfData['phone']}}</td>
                            </tr>
                            <tr style="background:#ffffff;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Email</th>
                                <td class="td" style="color:#1f2937;">{{$pdfData['email']}}</td>
                            </tr>
                            <tr style="background:#f9fafb;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Business
                                    Name</th>
                            ...
                            <tr style="background:#ffffff;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Payment Date
                                </th>
                                <td class="td" style="color:#1f2937;">{{$pdfData['payment_date'] ?? ''}}</td>
                            </tr>
                            <tr style="background:#f9fafb;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Payment Time
                                </th>
                                <td class="td" style="color:#1f2937;">{{$pdfData['payment_time']}}</td>
                            </tr>
                            <tr style="background:#ffffff;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Amount</th>
                            ...
                            <tr style="background:#ffffff;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Net Amount
                                    Paid</th>
                            ...
                            <tr style="background:#f9fafb;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Payment ID
                                </th>
                                <td class="td" style="color:#1f2937;">{{$pdfData['transaction_id']}}</td>
                            </tr>
                            <tr style="background:#ffffff;">
                                <th align="left" class="th heading" style="font-weight:700; color:#111827;">Payment Mode
                                </th>
